...
// La base de datos puede ubicarse en RESERVATIONS_DB_PATH (por ejemplo,
// /var/data/reservations.db en Render) y por defecto sigue usando
// server/reservations.db para desarrollo local.
const dbPath = ensureReservationsDbDirectory(resolveReservationsDbPath());
